...
static const char *fonts[]          = { "ProFontIIx Nerd Font:size=14" };
...
static char dmenuilim[] = "20";
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-l", dmenuilim, NULL};
